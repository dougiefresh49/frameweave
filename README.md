...
Planning is done; the build is starting. `docs/PLAN.md` is the plan and backlog, `docs/decisions.md` every owner decision, `docs/audit/` the evidence the plan was derived from. Until the M0 backlog items land, `uv sync` is the only command that works.
