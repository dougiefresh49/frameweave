...
| 2 | Output root | a Desktop folder; see Q20 for its name |
...
| 12 | GitHub remote | yes, public from the start, with a scrub gate on every push |
...
| 16 | Housekeeping outside the repo | after M1, owner-run |
